...
{id: 39, quantity: 1, code_id: 1, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "E280689400005002BD11A46A"},
{id: 40, quantity: 2, code_id: 6, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "E280689400005002BD11A45C,E28068940000400589A1653B"},
{id: 41, quantity: 1, code_id: 7, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "E280689400004002BD11A464"},
{id: 42, quantity: 2, code_id: 5, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "E28068940000400589A16540,E28068940000500589A1653F"},
{id: 43, quantity: 2, code_id: 3, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "E280689400004002BD11A461,E280689400004002BD11A45B"},
{id: 44, quantity: 2, code_id: 4, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "E280689400004002BD11A468,E28068940000500589A1653C"},
...
let result2 = beforeInputs.map((item)=>{
	return  {quantityBefore: item.quantity , tagsBefore: item.tags,code_id:item.code_id} 
})
console.log('result2')
console.log(result2)
...
for (var i = 0; i < beforeInputs.length; i++) {
  ...
  for (var j = 0; j < currentDataConverted.length; j++) {
    if (beforeInputs[i].code_id === currentDataConverted[j].code_id) { 
      ...
      for (let a = 0; a < before.length; a++) { //tagsBefore:
        for (let b = 0; b < current.length; b++) { //tags
...
console.log(difference)
let differenceSimetrica = arr1.filter(x => !arr2.includes(x)).concat(arr2.filter(x => !arr1.includes(x)));
