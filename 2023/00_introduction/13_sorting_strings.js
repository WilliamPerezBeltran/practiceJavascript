...
const anotherNumbers = [1,2,3,4,54,23,4234,23,6,679,8,545,321,5,654,]
const anotherNumbers1 = [1,2,3,4,54,23,4234,23,6,679,8,545,321,5,654,]
...
const num = [1,32,,45,4,67,45,3,23,45,34,7,45,574,557,45,35,46,0] 
num.sort((a,b)=>b-a)
console.log(num)

//ordenar descendetemente el array siguiente [1,32,,45,4,67,45,3,23,45,34,7,45,574,557,45,35,46,0]
const num1 = [1,32,,45,4,67,45,3,23,45,34,7,45,574,557,45,35,46,0] 
num1.sort((a,b)=>a-b)
console.log(num1)
