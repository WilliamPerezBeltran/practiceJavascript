let imitateDataUpload = [{id: 1, identifier: "E280689400004002BD11A468"},
...
let tags =  [{id: 73, tagName: "E280689400004002BD11A468" },
...
const result = imitateDataUpload.filter((elem) => !tags.find(({ tagName }) => elem.identifier === tagName));
