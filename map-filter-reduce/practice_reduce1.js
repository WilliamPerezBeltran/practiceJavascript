...
{id: 39, quantity: 1, code_id: 1, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "x"},
{id: 40, quantity: 2, code_id: 6, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "y,a"},
{id: 41, quantity: 1, code_id: 7, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "z"},
{id: 42, quantity: 2, code_id: 5, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "w,s"},
{id: 43, quantity: 2, code_id: 3, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "q,b"},
{id: 44, quantity: 2, code_id: 4, dateTime: "1/6/2021 11:37 AM", movementType: "entrada", tags: "e,h"},

]
beforeInputs = beforeInputs.map((item)=>{
	return {quantityBefore: item.quantity, code_id: item.code_id, tagsBefore: item.tags}
})
...
for (var i = 0; i < beforeInputs.length; i++) {
	...
	for (var j = 0; j < currentDataConverted.length; j++) {
		if (beforeInputs[i].code_id === currentDataConverted[j].code_id) { 
			...
			found = true 
			console.log(`code_id  `)
			console.log(`${beforeInputs[i].code_id }===${currentDataConverted[j].code_id} `)
			...
			console.log(current)
				...
				// }
				let inputObject = {
					quantity: ((inputArray.length === 1) && (inputArray[0] === '')) ?0:inputArray.length ,
